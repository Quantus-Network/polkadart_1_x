...
class SigningBuilder {
  ...
  SignedData createSignedExtrinsic({
    ...
    final signingPayload = createPayloadToSign(callData);
  ...
  Uint8List _createRawSigningPayload(Uint8List callData) {
  ...
  Uint8List createPayloadToSign(Uint8List callData) {
    extensionBuilder.validate();
    final payload = _createRawSigningPayload(callData);
  ...
  /// Unhashed signing payload. Hardware wallets parse this to display the call.
  Uint8List createRawPayloadToSign(Uint8List callData) {
    extensionBuilder.validate();
    return _createRawSigningPayload(callData);
  }
